...
exports.run = (client, message, params) => {
  ...
  if (message.channel.type !== 'dm') {
    ...
    .setDescription('Özel mesajlarını kontrol et. :postbox: (Botumuz eğlence amaçlı kurulmamıştır, yardım amaçlı kurulmuştur. Yakın zaman da eğlence amaçlı botumuz da aktifleşecektir...) :smile: :Feuerchen: ');
